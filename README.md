...
1. Download [RTL.Chatbot.Companion_1.0.9.firefox.signed.xpi](https://github.com/thenimaaa/RTL-Chatbot-Companion/releases/download/1.0.9/rtl_chatbot_companion-1.0.9.signed.xpi) file to your local machine.
2. Open Firefox.
